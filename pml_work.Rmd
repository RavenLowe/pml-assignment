...
Cross-validating the model results in an estimated error of `r paste(round(100 - cm_rf_probe$overall["Accuracy"]*100, 2), "%")` and the 95% confidence interval: [`r round(cm_rf_probe$overall["AccuracyLower"], 4)`, `r round(cm_rf_probe$overall["AccuracyUpper"], 4)`]. The validation results also in a high kappa statistic of `r round(cm_rf_probe$overall["Kappa"], 4)`, which suggest a very good classifier.
